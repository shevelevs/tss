...
namespace TopSecretSanta.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private void SendVerificationMail(RegisterModel user, string token)
        {
            ...
            MailMessage email = new MailMessage("shevelevs@gmail.com", user.Email);
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ...
            using (SecretSantaContext db = new SecretSantaContext()) 
                return View(new ManageAccountModel() { Password = new LocalPasswordModel(), Profile = db.UserProfiles.Find(WebSecurity.GetUserId(User.Identity.Name)) });
        }
        ...
        public ActionResult ChangePassword(LocalPasswordModel model)
        {
            ...
            // If we got this far, something failed, redisplay form
            using (SecretSantaContext db = new SecretSantaContext())
                return View("Manage", new ManageAccountModel() { Password = model, Profile = db.UserProfiles.Find(WebSecurity.GetUserId(User.Identity.Name)) });
